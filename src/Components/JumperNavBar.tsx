...
function JumperNavBar(props: {
	...
	/**
	 * Handles clicking of any of the filter buttons
	 * @param e - javascript event
	 */
	function handleClick(e: SyntheticEvent) {
		const dataType = e.currentTarget.getAttribute('data-type'); // TODO: refactor this to use react and not dom manipulation
